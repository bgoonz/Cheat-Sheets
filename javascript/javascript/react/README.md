...
* [JavaScript](./#javascript) - [You can also supply a custom validator to `arrayOf` and `objectOf`](./#you-can-also-supply-a-custom-validator-to-arrayof-and-objectof) - [is shown if the prop isn't provided](./#is-shown-if-the-prop-isnt-provided) - [optionalElement: PropTypes.element, You can also declare that a prop is an instance of a class. This uses](./#optionalelement-proptypeselement-you-can-also-declare-that-a-prop-is-an-instance-of-a-class-this-uses) - [(or fragment) containing these types](./#or-fragment-containing-these-types) - [Similar to renderToNodeStream, except this doesn't create extra DOM attributes that React uses](./#similar-to-rendertonodestream-except-this-doesnt-create-extra-dom-attributes-that-react-uses) - [Render a React element to its initial HTML. Returns a Readable stream that outputs an HTML string](./#render-a-react-element-to-its-initial-html-returns-a-readable-stream-that-outputs-an-html-string) - [Similar to renderToString, except this doesn't create extra DOM attributes that React uses](./#similar-to-rendertostring-except-this-doesnt-create-extra-dom-attributes-that-react-uses)
  ...
  * [EVENTS](./#events)
    ...
    * \[When using child\_process.fork() you can write to the child using child.send(message, \[sendHandle]) and messages are received by a 'message' event on the child]\(#when-using-child\_processfork-you-can-write-to-the-child-using-childsendmessage-sendhandle-and-messages-are-received-by-a-message-event-on-the-child)
    ...
    * [load another\_module as if require() was called from the module itself](./#load-another\_module-as-if-require-was-called-from-the-module-itself)
