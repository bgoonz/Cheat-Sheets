---
title: JavaScript 101 A modern JS utility library
subtitle: A modern JS utility library
date: "2022-01-03"
thumb_img_alt: A modern JS utility library
content_img_alt: A modern JS utility library
excerpt: 101 will be maintained to minimize overlap with vanilla JS. No need for custom builds.
seo:
  title: ""
  description: "101 will be maintained to minimize overlap with vanilla JS. No need for custom builds."
  robots: []
  extra: []
template: post
...
# JavaScript 101 A modern JS utility library
