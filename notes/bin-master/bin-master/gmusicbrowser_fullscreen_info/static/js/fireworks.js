...
$(document).ready(function () {
  ...
  Mousetrap.bind(["left", "p", "P"], function (e) {
    console.log(
      "Calling new version of function bound to ['left', 'p', 'P']..."
    );
    prev();
    fireTheFireworks();
  });
  Mousetrap.bind(["space", "b", "B"], function (e) {
    console.log(
      "Calling new version of function bound to ['space', 'b', 'B']..."
    );
    playpause();
    fireTheFireworks();
  });
  Mousetrap.bind(["right", "n", "N"], function (e) {
    console.log(
      "Calling new version of function bound to ['right', 'n', 'N']..."
    );
    next();
    fireTheFireworks();
  });
  Mousetrap.bind(["down", "d", "D"], function (e) {
    console.log(
      "Calling new version of function bound to ['down', 'd', 'D']..."
    );
    volumedown();
    fireTheFireworks();
  });
  ...
  Mousetrap.bind(["h", "H", "?"], function (e) {
    ...
    alert(
      "Use 'p' for previous song, 'n' for next song, 'space' for pause, 'f' to toggle full screen."
    );
    fireTheFireworks();
  });
});
